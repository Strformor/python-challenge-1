...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if menu_selection.isdigit(): 
                # Convert the menu selection to an integer`1`1
                ...
                else : print("You didn't select a valid option")
    ...
    while True:  
        ...
        if keep_ordering.lower() == 'y':
            break
                ...
                # Exit the keep ordering question loop1
            ...
            print("Thank you for the order, please comeback soon")
            ...
            break
                ...
                print ("Try again enter 'Y' or 'N' to continue.")
